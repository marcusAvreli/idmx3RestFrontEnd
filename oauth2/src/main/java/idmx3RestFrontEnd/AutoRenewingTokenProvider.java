...
import oauth2Client.client.RetryPolicy;
import oauth2Client.client.TokenChangeObservable;
import oauth2Client.client.TokenChangeObserver;
import oauth2Client.client.TokenService;
...
public class AutoRenewingTokenProvider<T extends AccessToken>  implements TokenChangeObservable<T>{
	  private static final Logger logger = 	            LogManager.getLogger( AutoRenewingTokenProvider.class );
