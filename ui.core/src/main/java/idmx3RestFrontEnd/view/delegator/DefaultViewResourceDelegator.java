...
import idmx3RestFrontEnd.view.delegator.converter.ViewResourceBooleanConverter;
import idmx3RestFrontEnd.view.delegator.converter.ViewResourceColorConverter;
import idmx3RestFrontEnd.view.delegator.converter.ViewResourceDimensionConverter;
import idmx3RestFrontEnd.view.delegator.converter.ViewResourceIconConverter;
import idmx3RestFrontEnd.view.delegator.converter.ViewResourceImageConverter;
import idmx3RestFrontEnd.view.delegator.converter.ViewResourcePrimitiveBooleanConverter;
import idmx3RestFrontEnd.view.delegator.converter.ViewResourceStringConverter;
...
public class DefaultViewResourceDelegator implements ViewResourceDelegator {
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.delegator.ViewResourceDelegator#clearResources(java.lang.Object, java.lang.Class)
	 */
	...
	/**
	 * If no control is defined it returns a idmx3RestFrontEnd.util.LastModifiedControl class.
	 * 
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.example.person.view.util.ViewResourceDelegator#injectResources(java.lang.Object, java.lang.Class)
	 */
	...
	/**
	 *  This method loads the default converters located in the following package "idmx3RestFrontEnd.view.delegator.converter"
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.delegator.ViewResourceDelegator#setViewResourceConverters(java.util.Map)
	 */
