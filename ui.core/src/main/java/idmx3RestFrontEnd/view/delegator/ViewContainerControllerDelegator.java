...
import idmx3RestFrontEnd.controller.GenericListenerHandler;
import idmx3RestFrontEnd.controller.ListenerProxy;
...
import idmx3RestFrontEnd.view.ViewContainerDialog;
...
public class ViewContainerControllerDelegator implements Delegator {
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.delegator.ViewContainerControllerDelegator#cleanControllers(idmx3RestFrontEnd.view.ViewContainer)
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.ViewContainerControllerDelegator#injectControllers(idmx3RestFrontEnd.view.ViewContainer, java.util.Map)
	 */
