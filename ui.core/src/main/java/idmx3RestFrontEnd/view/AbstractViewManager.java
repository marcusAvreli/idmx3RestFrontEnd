...
import idmx3RestFrontEnd.annotation.processor.ControllersProcessor;
import idmx3RestFrontEnd.annotation.processor.ListenersProcessor;
...
public abstract class AbstractViewManager implements ViewManager
{
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.ViewManager#addView(idmx3RestFrontEnd.view.ViewContainer, idmx3RestFrontEnd.view.perspective.PerspectiveConstraint)
	 */
