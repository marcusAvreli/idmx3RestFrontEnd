package idmx3RestFrontEnd.view.perspective;
...
import idmx3RestFrontEnd.util.ButtonTabComponent;
...
public class DefaultPerspective implements Perspective {
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.ViewAware#addView(idmx3RestFrontEnd.view.ViewContainer, idmx3RestFrontEnd.view.perspective.PerspectiveConstraint)
	 */
	public void addView(ViewContainer view, PerspectiveConstraint constraint) {
		...
		ButtonTabComponent componentAt = 
			new ButtonTabComponent(rightToLeft,topBottom,panel,view,viewIcon);
