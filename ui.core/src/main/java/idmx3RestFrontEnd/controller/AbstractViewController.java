...
import idmx3RestFrontEnd.view.ViewContainerLocator;
import idmx3RestFrontEnd.view.ViewContainerLocatorAware;
	...
	implements ViewController<EL,EO>,ViewContainerLocatorAware
{
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewController#executeHandler(idmx3RestFrontEnd.view.ViewContainer, java.util.EventObject)
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewController#getViewManager()
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewController#handleView(idmx3RestFrontEnd.view.ViewContainer, java.util.EventObject)
	 */
	public void handleView(final ViewContainer view, final EO eventObject) throws BackgroundException{ }

	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewController#postHandlingView(idmx3RestFrontEnd.view.ViewContainer, java.util.EventObject)
	 */
	public void postHandlingView(ViewContainer view, EO eventObject) throws ViewException{ }
	
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewController#postHandlingViewOnError(idmx3RestFrontEnd.view.ViewContainer, java.util.EventObject, idmx3RestFrontEnd.controller.BackgroundException)
	 */
	public void postHandlingViewOnError(ViewContainer view, EO eventObject,BackgroundException th) throws ViewException{ }

	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewController#preHandlingView(idmx3RestFrontEnd.view.ViewContainer, java.util.EventObject)
	 */
	public void preHandlingView(ViewContainer view, EO eventObject) throws ViewException { }

	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ListenerProxy#getTargetController()
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.ViewContainerLocatorAware#locate(java.lang.Class)
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.ViewContainerLocatorAware#locate(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.view.ViewContainerLocatorAware#locateRootView()
	 */
