...
public class DefaultViewControllerDispatcher implements ViewControllerDispatcher {
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewControllerDispatcher#addController(java.lang.String, idmx3RestFrontEnd.controller.ViewController)
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewControllerDispatcher#getControllers()
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewControllerDispatcher#removeController(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see idmx3RestFrontEnd.controller.ViewControllerDispatcher#setControllers(java.util.Map)
	 */
